...
{{- default .Chart.Name .Values.inviteme.nameOverride | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- if .Values.inviteme.fullnameOverride }}
{{- .Values.inviteme.fullnameOverride | trunc 63 | trimSuffix "-" }}
{{- else }}
{{- $name := default .Chart.Name .Values.inviteme.nameOverride }}
